...
public class LeftFoot extends MyLocatable implements Appendage {//similar shape to the angles used for arms and legs
											//although smaller and directed horizontally to the left
		private Line toeOne,toeTwo;
		
		public LeftFoot(int initX,int initY,int length){
			super(initX,initY);
